...
asmlinkage int sys_os2024_ku_cpu_fcfs(char*, int);
asmlinkage int sys_os2024_ku_cpu_srtf(char*, int);
asmlinkage int sys_os2024_ku_cpu_rr(char*, int);
asmlinkage int sys_os2024_ku_cpu_priority(char*, int, int);
/* sslab --- end */
